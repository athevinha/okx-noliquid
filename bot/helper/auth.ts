...
export const makeHeaderAuthenticationOKX = (method: IMethod, path: string, body: string) => {
    return {
        ...
        'OK-ACCESS-SIGN': createSignature(decodeTimestamp(Date.now(), 0), method, path, body, process.env.OKX_SECRET_KEY)
    }
}